...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 hotline-search">
                        ...
                        <!-- forrm dùng phương thức GET là không dùng tham số trong action -->
                        <!-- để giải quyết param lên server thì thêm input : hidden -->
        ...
        <div class="error bg-primary text-center" style="color:red">
            <?=!empty($_SESSION["error"]) ? $_SESSION["error"] : "" ?>
        </div>
        <?php unset($_SESSION["error"]); ?>

        <div class="message bg-info text-center" style="color:blue">
