...
class StaffRepository extends BaseRepository{
	...
	function save($data) {
		...
		$sql = "INSERT INTO staff (name, password, mobile, email, role_id, username) VALUES ('$name', '$password', '$mobile', '$email', $role_id, '$username')";
	...
	function update($staff) {
		...
		$sql = "UPDATE staff 
			SET name='$name', password='$password', mobile='$mobile', email='$email', username='$username', role_id='$role_id'
			WHERE id=$id";
